...
urlpatterns = [
    ...
    path("api/biomero/admin/config/", views.get_biomero_config, name="get_biomero_config"),         # GET /config    
    ...
    path("api/biomero/admin/config/save/", views.save_biomero_config, name="save_biomero_config"),  # POST /config/save/
    # Webclient URLs
